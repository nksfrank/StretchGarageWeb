...
namespace DataLayer.Database
{
	...
	public partial class ParkingPlace : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _OuterBound;
		
		private int _InnerBound;
    ...
    partial void OnOuterBoundChanging(int value);
    partial void OnOuterBoundChanged();
    partial void OnInnerBoundChanging(int value);
    partial void OnInnerBoundChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_OuterBound", DbType="Int NOT NULL")]
		public int OuterBound
		{
			get
			{
			...
			set
			{
				if ((this._OuterBound != value))
				{
					this.OnOuterBoundChanging(value);
					this.SendPropertyChanging();
					this._OuterBound = value;
					this.SendPropertyChanged("OuterBound");
					this.OnOuterBoundChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_InnerBound", DbType="Int NOT NULL")]
		public int InnerBound
		{
			...
			set
			{
				if ((this._InnerBound != value))
				{
					this.OnInnerBoundChanging(value);
					this.SendPropertyChanging();
					this._InnerBound = value;
					this.SendPropertyChanged("InnerBound");
					this.OnInnerBoundChanged();
				}
			}
		}
